...
from Agent.op_select_agent import (
    ...
    UCBDecision,
    Win_UCBDecision_discount,
    LLMDecisionPolicy,
    TemplateRewriteDecision,
    Window_UCBDecision,
    TemplateRuleDecision,
    TemplateRuleDecision_limited,  # according the rule to decise updating template
)
...
if __name__ == "__main__":
    ...
    timestamp = "12_50_120_WinUCB_Discount_CTbyRule"  # debug 限定不变
    ...
    #     seed=20250906,
    # )
    Op_Policy = Win_UCBDecision_discount(
        operators=operators_to_optimize,
        c=1.0,
        seed=20250906,
    )
    ...
    for cycle in range(max_cycles):
        ...
        operator_name, do_rewrite = Op_Policy.decide(cycle, op_features, stor=storages)
