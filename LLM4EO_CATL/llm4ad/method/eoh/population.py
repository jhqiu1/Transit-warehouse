...
class Population:
    def __init__(
        self, pop_size, generation=0, pop: List[Function] | Population | None = None
    ):
        if pop is None:
            self._population = []
        ...
        self._history_sampling_pops = []  # 添加用于记录历史种群的列表
    ...
    # 获取历史种群
    @property
    def history_sampling_pops(self):
        return self._history_sampling_pops
    ...
    def register_function(self, func: Function):
        ...
        try:
            ...
            self._history_sampling_pops.append(func)
