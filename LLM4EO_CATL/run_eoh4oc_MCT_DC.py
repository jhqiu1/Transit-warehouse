...
class MCTS:
    ...
    def expand(self, generation, node):
        ...
        if generation in self.target_generations:
            self.sampling_history_var()  # sampling new template
...
if __name__ == "__main__":
    ...
    timestamp = "MCT_FIX2"  # fixed timestamp for result comparison
